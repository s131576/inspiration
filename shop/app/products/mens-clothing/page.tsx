...
const Page: React.FC = () => {
  ...
  return (
    <div className='bg-gradient-to-r  from-cyan-600 min-h-screen'>
      {/* Header Section */}
      <header className="bg-gradient-to-r from-cyan-800 py-8 text-white text-center shadow-md">
        <h1 className="text-5xl font-extrabold">Men's Clothing</h1>
        <p className="text-xl mt-2">Explore the latest trends in men's fashion.</p>
      </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {products.length > 0 ? (
              ...
              <div className="col-span-full text-center text-gray-500">
                <p>No men's clothing available at the moment.</p>
              </div>
            )}
          </div>
        </section>
